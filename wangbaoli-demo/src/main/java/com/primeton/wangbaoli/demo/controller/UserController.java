...
public class UserController {
	...
	public ResponseResult<List<User>> queryUsers(@RequestParam(value = "page", defaultValue = "0") Integer page,
		...
		List<User> list = userService.queryUsers(page, size);
	...
	public ResponseResult<List<User>> queryUsersByUsername(@PathVariable(value = "username") String username,
			@RequestParam(value = "page", defaultValue = "0") Integer page,
			@RequestParam(value = "size", defaultValue = "0") Integer size) throws DemoException {
		List<User> data = userService.queryByLikename(username, page, size);
